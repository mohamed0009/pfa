-- ============================================================================
-- COMPLETE DATABASE SCHEMA FOR COACH AI PLATFORM
-- ============================================================================
-- This script creates the complete database schema for the Coach AI platform
-- Execute this script after creating the database: CREATE DATABASE coach_ai_db;
-- ============================================================================
...
CREATE TABLE preferred_content_types (
    ...
    content_type VARCHAR(50) NOT NULL CHECK (content_type IN ('VIDEO', 'LECTURE', 'EXERCICE_PRATIQUE', 'QUIZ', 'SIMULATION')),
...
CREATE TABLE formations (
    ...
    CONSTRAINT fk_formation_created_by FOREIGN KEY (created_by) REFERENCES users(id) ON DELETE SET NULL,
...
CREATE TABLE courses (
    ...
    CONSTRAINT fk_course_module FOREIGN KEY (module_id) REFERENCES modules(id) ON DELETE SET NULL,
...
CREATE TABLE lessons (
    ...
    type VARCHAR(50) NOT NULL CHECK (type IN ('VIDEO', 'LECTURE', 'QUIZ', 'EXERCISE', 'AI_CHAT')),
    title VARCHAR(255) NOT NULL,
    description TEXT,
...
CREATE TABLE user_notifications (
    id VARCHAR(255) PRIMARY KEY,
    user_id VARCHAR(255) NOT NULL,
    type VARCHAR(50) NOT NULL CHECK (type IN ('REMINDER', 'NEW_CONTENT', 'MOTIVATION', 'ALERT', 'ACHIEVEMENT')),
    title VARCHAR(255) NOT NULL,
    message TEXT NOT NULL,
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    read_at TIMESTAMP,
